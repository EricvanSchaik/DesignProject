...
class DeviceOffset:
    ...
    def get_offset(self, cam_id, sens_id, date):
        c = self.conn.cursor()
        c.execute(self.sql_queryDate, (cam_id, sens_id, date))
    ...
    def set_offset(self, cam_id, sens_id, offset, date):
        c = self.conn.cursor()
        c.execute(self.sql_updateOffset, (offset, cam_id, sens_id, date))
        self.conn.commit()
