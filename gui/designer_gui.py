...
class Ui_VideoPlayer(object):
    def setupUi(self, VideoPlayer):
        ...
        self.verticalLayout_controls.addWidget(self.label_4)
        self.comboBox = QtWidgets.QComboBox(self.verticalLayoutWidget_2)
        self.comboBox.setObjectName("comboBox")
        self.verticalLayout_controls.addWidget(self.comboBox)
        self.label_2 = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        self.label_2.setObjectName("label_2")
        self.verticalLayout_controls.addWidget(self.label_2)
        ...
        self.verticalLayout_controls.addWidget(self.label_3)
    ...
    def retranslateUi(self, VideoPlayer):
        ...
        self.label_2.setText(_translate("VideoPlayer", "Name"))
        self.label_3.setText(_translate("VideoPlayer", "Regular Expression"))
